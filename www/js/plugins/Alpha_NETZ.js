/*:
 * @plugindesc (v.0.8.1)[PRO] Multiplayer for RPG Maker
 ...
 */
 /*:ru
 * @plugindesc (v.0.8.1)[PRO] Мультиплеер для RPG Maker
 * @author Pheonix KageDesu
 * @target MZ MV
 * @url https://kdworkshop.net/plugins/alpha-net-z/
 *
...
//---------------------------------------------------------------------------
(function() {
  var ALIAS___fillNetworkObserver, ALIAS__initMembers, ALIAS__updateSelfMovementNNX, _;
  //@[DEFINES]
  ...
  ParamsManager = (function() {
    class ParamsManager extends KDCore.ParamLoader {
      ...
      isAllowCollsBetweenNetChars() {
        return this.getParam("isAllowCollisForNetChars", false);
      }
...
//Plugin Alpha_NETZ builded by PKD PluginBuilder 2.2 - 30.06.2023